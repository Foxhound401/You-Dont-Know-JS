...
One fix is to use the character iteration (via `...` operator) we saw in the previous section, as it automatically returns each combined character from a surrogate pair:
